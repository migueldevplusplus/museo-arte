...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('credit_card_number', models.CharField(help_text='Format: XXXX-XXXX-XXXX-XXXX', max_length=19)),
                ('security_code', models.CharField(blank=True, max_length=10, null=True)),
